<template>
  ...
  <TempRenderer3 v-if="compProps.temp == '3'" :compProps="compProps" :isClick="isClick" />
  <TempRenderer4 v-if="compProps.temp == '4'" :compProps="compProps" :isClick="isClick" />
</template>
...
import TempRenderer3 from './temp3/Renderer';
import TempRenderer4 from './temp4/Renderer';
